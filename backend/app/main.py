...
from app.api.routes import session, voice, schemes, eligibility, handoff, auth, chat, scheme_guide
...
app.include_router(scheme_guide.router, prefix="/schemes", tags=["Scheme Guide"])
